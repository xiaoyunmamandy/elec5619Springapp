...
<body>
	...
	<div class="container">
	        <div class="card card-container">
	            ...
	            <form action="/elec5619Springapp/adminlogin" method="post"
		enctype="multipart/form-data" onsubmit="return submitvalification()">
	           
	                <span id="reauth-email" class="reauth-email"></span>
	                <input type="text" name="adusername" id="inputEmail" class="form-control" placeholder="username" required autofocus>
