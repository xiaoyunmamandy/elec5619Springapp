					...
					<table id="register">
						...
						<tr>
							<td>email: <input type="text" name="email" id="email"
								value="${model.user.email }"></td>
						</tr>
						<tr>
							<td>Profile photo:<img src="/imgUrl/${model.user.picture }"
								height="30px" width="30px" /> <input type="hidden"
								value="${model.user.picture }" name="orignpersonImg" /></br> <input
								type="file" name="personImg" id="personImg" /></td>
						</tr>
					</table>
